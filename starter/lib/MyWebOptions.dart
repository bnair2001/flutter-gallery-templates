...
import 'package:myweb/constants.dart';
...
class MyWebOptions {
  ...
  static MyWebOptions of(BuildContext context) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
    return scope.modelBindingState.currentModel;
  }

  static void update(BuildContext context, MyWebOptions newModel) {
    final scope =
        context.dependOnInheritedWidgetOfExactType<_ModelBindingScope>();
...
// Applies text MyWebOptions to a widget
class ApplyTextOptions extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final options = MyWebOptions.of(context);
...
class ModelBinding extends StatefulWidget {
  ModelBinding({
    Key key,
    this.initialModel = const MyWebOptions(),
    this.child,
  })  : assert(initialModel != null),
        super(key: key);

  final MyWebOptions initialModel;
  final Widget child;
...
class _ModelBindingState extends State<ModelBinding> {
  ...
  void handleTimeDilation(MyWebOptions newModel) {
  ...
  void updateModel(MyWebOptions newModel) {
